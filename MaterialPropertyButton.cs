...
public class MaterialPropertyButton : MonoBehaviour
{
    ...
    [Range(0.1f, 5f)] public float targetFlatBrushAspectRatio = 3f;
    ...
    public void ApplyToBrush()
    {
        ...
        // Apply flat brush-specific properties
        if (targetShape == BrushSettings.BrushShape.Flat)
        {
            settings.flatBrushAspectRatio = targetFlatBrushAspectRatio;
        }
